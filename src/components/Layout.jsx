...
import { updateUser, uploadAvatar } from '../lib/supabaseDB';
...
export default function Layout() {
  ...
  return (
    <div className="app-shell">
      ...
      <Modal isOpen={profileModal} onClose={() => setProfileModal(false)} title="My Profile" confirmText={savingProfile ? "Saving..." : "Save Profile"} onConfirm={saveProfile}>
